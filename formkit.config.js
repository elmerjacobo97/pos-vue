  ...
  config: {
    classes: generateClasses({
      global: {
        ...
        input:
          'block w-full rounded-md border-0 py-2 px-3 text-gray-700 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue sm:text-sm sm:leading-6'
      },
      text: {},
      number: {},
      file: {
